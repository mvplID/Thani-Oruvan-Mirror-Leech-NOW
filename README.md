...
contact me :- [THANI ORUVAN](https://t.me/ben10tamizh)

# Thani Oruvan Mirror Leech Bot
This is a telegram bot writen in python for mirroring files on the internet to our beloved Google Drive.

## Deploying on Heroku

Give Star & Fork this repo, then upload **token.pickle** or add TOKEN_PICKLE_URL in Config

By Using GitHub Workflow similarly used in other Repos
...
- Clone this repo:
```
git clone https://github.com/thanioruvangkls/thanioruvangkls/Thani-Oruvan-Mirror-Leech
cd thanioruvangkls/Thani-Oruvan-Mirror-Leech
```
...
- **BASE_URL_OF_BOT**: Must for escape from Bot Idling.
### Optional Field
...
- **TELEGRAPH_TITLE**: List Command and Help Commands Telegraph Title.
- **TELEGRAPH_AUTHOR**: Telegrph Author or Owner Name
- **TELEGRAPH_AUTH_URK**: Telegraph author or owner User name Must Be in https:// format
...
## Yt-dlp authentication using .netrc file
...
- [Thanioruvan](https://github.com/thanioruvangkls) for nothing
