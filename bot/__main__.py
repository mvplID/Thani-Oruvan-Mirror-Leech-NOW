...
from bot import bot, app, dispatcher, updater, botStartTime, IGNORE_PENDING_REQUESTS, TELEGRAPH_TITLE, IS_VPS, PORT, alive, web, OWNER_ID, AUTHORIZED_CHATS
...
from .modules import authorize, list, cancel_mirror, mirror_status, mirror, clone, watch, shell, eval, search, delete, speedtest, count, leech_settings ,bypass
...
def start(update, context):
    ...
    buttons.buildbutton("Repo", "https://github.com/thanioruvangkls/Thani-Oruvan-Mirror-Leech")
    buttons.buildbutton("Channel", "https://t.me/Eswarleech")
    reply_markup = InlineKeyboardMarkup(buttons.build_menu(2))
    if CustomFilters.authorized_user(update) or CustomFilters.authorized_chat(update):
        start_string = f'''
This bot can mirror all your links to Google Drive and Leech to Telegram!
Type /{BotCommands.HelpCommand} to get a list of available commands
'''
        sendMarkup(start_string, context.bot, update, reply_markup)
    else:
        sendMarkup(
            'Oops! not a Authorized user.\nPlease deploy your own <b>Thani-Oruvan-Mirror-Leech</b>.',
            context.bot,
            update,
            reply_markup,
        )
...
<br><br>
<b>/{BotCommands.RlbCommand}</b>: To bypass Rocklinks
<br><br>
...
botcmds = [
        ...
        (f'{BotCommands.RlbCommand}','Bypass Rocklinks Only'),
